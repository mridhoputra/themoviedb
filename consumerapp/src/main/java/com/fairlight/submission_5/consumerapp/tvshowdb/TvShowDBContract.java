package com.fairlight.submission_5.consumerapp.tvshowdb;

import android.net.Uri;
import android.provider.BaseColumns;

public class TvShowDBContract {
    private static final String TV_SHOW_AUTHORITY = "com.fairlight.submission_5.themoviedb.provider.TvShowProvider";
    private static final String SCHEME = "content";
    private static String TABLE_NAME = "table_tv_show";
