...
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_APP_TITLE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_BACKDROP_URL;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_DESCRIPTION;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_ID_FROM_API;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_IS_FAVORITE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_ORIGINAL_LANGUAGE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_POPULARITY;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_POSTER_URL;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_RELEASED_DATE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_TITLE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_USER_SCORE;
import static com.fairlight.submission_5.consumerapp.moviedb.MovieDBContract.MovieColumns.MOVIE_VOTE_COUNT;
