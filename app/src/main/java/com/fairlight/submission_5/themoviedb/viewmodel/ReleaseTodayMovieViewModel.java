...
public class ReleaseTodayMovieViewModel extends ViewModel {
    private static final String API_KEY = BuildConfig.TMDB_API_KEY;
    private MutableLiveData<ArrayList<Catalogue>> listTodayMovies = new MutableLiveData<>();

    public void setListTodayMovies() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (movie_responseArray.length() > 0) {
                        ...
                        listTodayMovies.postValue(null);
                    }
                } catch (Exception e) {
    ...
    public LiveData<ArrayList<Catalogue>> getListTodayMovies() {
