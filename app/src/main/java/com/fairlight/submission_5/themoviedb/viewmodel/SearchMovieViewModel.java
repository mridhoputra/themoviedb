...
public class SearchMovieViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<Catalogue>> listSearchedMovies = new MutableLiveData<>();

    public void setListSearchedMovies(String query) {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (movie_responseArray.length() > 0) {
                        ...
                        listSearchedMovies.postValue(null);
                    }
                } catch (Exception e) {
