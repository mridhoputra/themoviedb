...
public class TvShowViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<Catalogue>> listTvShows = new MutableLiveData<>();
    ...
    public void setListTvShows() {
        ...
        String url = "https://api.themoviedb.org/3/discover/tv?api_key=" + API_KEY + "&language=" + api_language_code;
        Log.d("Check url: ", url);
